...
namespace GameBd.WebClient.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            var users = db.Users.Include(u => u.UserGroups);
        ...
        {
            ViewBag.user_group_id = new SelectList(db.UserGroups, "user_group_id", "descr");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "user_id,login,password_hash,salt,firstname,lastname,email,date_created,user_group_id")] Users users)
        {
            if (ModelState.IsValid)
            {
